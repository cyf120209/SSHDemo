 ...
 */
public class ShadeEntity implements Serializable {
...
//    private Set shadeGroups=new HashSet();
    ...
    public ShadeEntity(Integer shadeId, String shadeName, Integer shadePosition, Integer shadePriority, String shadeStatus) {
